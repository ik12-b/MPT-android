...
android {
    namespace = "com.moneyprinter.turbo"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.moneyprinter.turbo"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // FFmpeg (for advanced video composition)
    // Note: use full or min package depending on needs. Full is large.
